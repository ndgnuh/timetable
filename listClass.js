class Class {
	constructor(name, place, day, sh, sm, eh, em, color="#424242", week="") {
		this.name = name
		this.place = place
		this.day = day
		this.sh = sh
...
const listClass = [
	...
	new Class("Quân sự chung", "SVD", 5, 13,00,17,00, color.brown, "4-9"),
	new Class("Tư tưởng HCM", "C1-302", 4,15,05,17,35, color.lime),
	new Class("Tin đại cương", "C1-302",5,6,45,10,05, color.teal),
	new Class("Tin đại cương", "D5-302",6,15,05,17,35, color.teal, "7,9,12,14,16"),
	new Class("VLĐC II (TN)","D3-?",7,6,45,9,15,color.orange, "3-8"),
]